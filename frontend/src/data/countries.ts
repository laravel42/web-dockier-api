export const countries: [string, string][] = [
  ...
  ["cz", "Czech Republic"], ["ci", "Côte d'Ivoire"], ["dk", "Denmark"], ["dj", "Djibouti"],
  ...
  ["hm", "Heard Island and McDonald Islands"], ["hn", "Honduras"], ["hk", "Hong Kong SAR China"],
  ...
  ["re", "Réunion"], ["bl", "Saint Barthélemy"], ["sh", "Saint Helena"],
  ...
  ["gs", "South Georgia and the South Sandwich Islands"], ["kr", "South Korea"], ["es", "Spain"],
  ...
  ["tc", "Turks and Caicos Islands"], ["tv", "Tuvalu"], ["um", "U.S. Minor Outlying Islands"],
