...
const STYLES: Record<string, { bg: string; text: string; border: string; icon: ReactElement }> = {
  error: {
    bg: "bg-danger-500/30", text: "text-danger-500", border: "border-danger-500/30",
  ...
  warning: {
    bg: "bg-warning-500/30", text: "text-warning-500", border: "border-warning-500/30",
  ...
  info: {
    bg: "bg-sky-500/30", text: "text-sky-300", border: "border-sky-500/30",
  ...
  clean: {
    bg: "bg-success-500/30", text: "text-success-500", border: "border-success-500/30",
