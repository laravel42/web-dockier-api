          ...
          {commands.map((cmd, index) => (
            ...
            >
              ...
              <button
                ...
                className={`mt-0.5 relative inline-flex h-4 w-7 flex-shrink-0 items-center rounded-full transition-colors ${
                ...
                <div className="flex items-center gap-3 mt-1">
                  <label className="flex items-center gap-1 cursor-pointer">
                    <input
                      ...
                      className="w-3 h-3 rounded border-border text-primary-500 focus:ring-primary-500/30"
                    />
